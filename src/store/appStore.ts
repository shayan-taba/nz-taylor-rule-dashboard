...
interface AppStore {
  ...
  setUseRealRStarOverride: (
    v: boolean
  ) => void;

  setUsePiStarOverride: (
    v: boolean
  ) => void;
        ...
        if (id === null) {
          ...
          if (regime) {
            set({
              ...
              dateRange: {
                start:
                  regime.startDate.split("T")[0],

                end: regime.endDate
                  ? regime.endDate.split("T")[0]
                  : today,
              },
